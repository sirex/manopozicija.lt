...
class ParseVotesTests(unittest.TestCase):
    ...
    def test_bals_9466(self):
        ...
        html = pres.resource_string('manopozicija.website.tests', 'fixtures/bals-9466.html')
        result = parse_votes(url, html)
        table = result.pop('table')
    ...
    def test_bals_1132(self):
        ...
        html = pres.resource_string('manopozicija.website.tests', 'fixtures/bals-1132.html')
        result = parse_votes(url, html)
        table = result.pop('table')
